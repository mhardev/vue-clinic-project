    ...
    <div class="py-8 px-4 mx-8 max-w-screen-xl sm:py-16 lg:px-6">
      <div class="max-w-screen-md mb-8 lg:mb-16">
        ...
        <p class="text-gray-500 sm:text-xl dark:text-gray-400">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Nemo voluptatem aliquam ullam ex
          facere, quidem repellendus consequatur, temporibus magni nostrum velit similique dolor
          reprehenderit porro eos sit excepturi laboriosam minus.
        </p>
      </div>
